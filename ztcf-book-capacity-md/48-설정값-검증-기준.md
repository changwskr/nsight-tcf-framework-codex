...
**검증 기준** — CPU/Heap/Thread/Pool/TPS/p95.
...
본 절(**CPU 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
**설정 파일**: `Z 부록` · **핵심 항목**: CPU·p95·Pending
...
본 절(**Heap·GC 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**Busy Thread 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**DB Pool 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**TPS·응답시간 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**오류율 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**Timeout 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**Connection 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**세션 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
### 48.10 Scale-out 효과 검증

본 절(**Scale-out 효과 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 절(**장애복구 검증**)은 검증 기준 영역에서 **합격 기준** 관점의 NSIGHT 1차 표준을 정의합니다. 피크 **720 TPS**·p95 **3초 이하**·8 vCPU / 32GB 기준으로 권고값을 제시하며, 최종값은 선도개발·성능시험(360/720/1080) 실측으로 확정합니다.
...
본 장은 **검증 기준**(합격 기준)의 핵심을 23장(JVM)과 동일한 깊이로 요약합니다.
