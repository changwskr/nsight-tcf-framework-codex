...
> **용도**: 로그·APM · **연관 본문**: 36, 49장

## 로그·모니터링 설정표 — 실무 템플릿

본 부록은 **관측성** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 U** — **Access Log** (로그·모니터링 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 U** — **GC Log** (로그·모니터링 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 U** — **APM·MDC** (로그·모니터링 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 U** — **임계치** (로그·모니터링 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 U** — **검증** (로그·모니터링 설정표) NSIGHT 1차 표준 적용 기준입니다.
