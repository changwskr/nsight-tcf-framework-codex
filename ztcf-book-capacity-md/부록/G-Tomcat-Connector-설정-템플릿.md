...
> **용도**: server.xml · **연관 본문**: 22장

## Tomcat Connector 설정 템플릿 — 실무 템플릿

본 부록은 **Tomcat Connector** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.

### Tomcat Connector 템플릿 (8C/32G)
...
본 절은 **부록 G** — **Connector 기본** (Tomcat Connector 설정 템플릿) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 G** — **Thread·Queue** (Tomcat Connector 설정 템플릿) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 G** — **KeepAlive** (Tomcat Connector 설정 템플릿) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 G** — **내장 Tomcat** (Tomcat Connector 설정 템플릿) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 G** — **검증** (Tomcat Connector 설정 템플릿) NSIGHT 1차 표준 적용 기준입니다.
