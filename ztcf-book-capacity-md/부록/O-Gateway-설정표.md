...
> **용도**: Gateway · **연관 본문**: 21장

## Gateway 설정표 — 실무 템플릿

본 부록은 **Route·CB** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 O** — **Route Timeout** (Gateway 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 O** — **Circuit Breaker** (Gateway 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 O** — **Rate Limit** (Gateway 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 O** — **Bulkhead** (Gateway 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 O** — **검증** (Gateway 설정표) NSIGHT 1차 표준 적용 기준입니다.
