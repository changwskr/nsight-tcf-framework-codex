...
본 부록은 **변경관리** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 AB** — **변경 요청** (설정 변경관리대장) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AB** — **영향도** (설정 변경관리대장) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AB** — **승인·검증** (설정 변경관리대장) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AB** — **반영·이력** (설정 변경관리대장) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AB** — **Rollback** (설정 변경관리대장) NSIGHT 1차 표준 적용 기준입니다.
