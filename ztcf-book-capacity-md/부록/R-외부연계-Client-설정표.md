...
> **용도**: CruzAPIM · **연관 본문**: 32장

## 외부연계 Client 설정표 — 실무 템플릿

본 부록은 **HTTP Client** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 R** — **Connect·Read** (외부연계 Client 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 R** — **Circuit Breaker** (외부연계 Client 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 R** — **Bulkhead** (외부연계 Client 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 R** — **Retry 정책** (외부연계 Client 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 R** — **검증** (외부연계 Client 설정표) NSIGHT 1차 표준 적용 기준입니다.
