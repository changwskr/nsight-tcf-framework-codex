...
> **용도**: 프로파일 적용 · **연관 본문**: 37~40장

## 8C·16C·32C 표준 설정 프로파일 — 실무 템플릿

본 부록은 **8C/16C/32C** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.

### 8C·16C·32C 표준 프로파일 요약
...
본 절은 **부록 F** — **8C/32G 프로파일** (8C·16C·32C 표준 설정 프로파일) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 F** — **16C 프로파일** (8C·16C·32C 표준 설정 프로파일) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 F** — **32C 프로파일** (8C·16C·32C 표준 설정 프로파일) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 F** — **업무별 차등** (8C·16C·32C 표준 설정 프로파일) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 F** — **적용** (8C·16C·32C 표준 설정 프로파일) NSIGHT 1차 표준 적용 기준입니다.
