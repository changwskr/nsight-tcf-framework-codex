...
> **용도**: DB Session 합산 · **연관 본문**: 26, 28장

## 전체 DB Connection 합산표 — 실무 템플릿

본 부록은 **Pool 총량** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.

### 전체 DB Connection 합산표
...
본 절은 **부록 V** — **온라인 Pool 합산** (전체 DB Connection 합산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 V** — **배치·BI** (전체 DB Connection 합산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 V** — **DB max sessions** (전체 DB Connection 합산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 V** — **판정** (전체 DB Connection 합산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 V** — **검증** (전체 DB Connection 합산표) NSIGHT 1차 표준 적용 기준입니다.
