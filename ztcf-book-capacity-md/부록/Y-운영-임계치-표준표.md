...
> **용도**: APM 임계치 · **연관 본문**: 49장

## 운영 임계치 표준표 — 실무 템플릿

본 부록은 **Warning/Critical** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 Y** — **CPU·Heap** (운영 임계치 표준표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Y** — **Thread·Pool** (운영 임계치 표준표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Y** — **GC·p95** (운영 임계치 표준표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Y** — **오류율** (운영 임계치 표준표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Y** — **조치** (운영 임계치 표준표) NSIGHT 1차 표준 적용 기준입니다.
