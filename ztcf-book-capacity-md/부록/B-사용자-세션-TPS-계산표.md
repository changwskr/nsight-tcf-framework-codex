...
> **용도**: TPS 산출 · **연관 본문**: 8, 9장

## 사용자·세션·TPS 계산표 — 실무 템플릿

본 부록은 **사용자·TPS 계산** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 B** — **사용자·세션** (사용자·세션·TPS 계산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 B** — **동시요청·TPS** (사용자·세션·TPS 계산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 B** — **AP·Pool 연계** (사용자·세션·TPS 계산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 B** — **시나리오별 표** (사용자·세션·TPS 계산표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 B** — **검증** (사용자·세션·TPS 계산표) NSIGHT 1차 표준 적용 기준입니다.
