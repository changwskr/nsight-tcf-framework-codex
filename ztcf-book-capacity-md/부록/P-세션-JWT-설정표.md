...
> **용도**: 세션·JWT · **연관 본문**: 29, 30장

## 세션·JWT 설정표 — 실무 템플릿

본 부록은 **Session·JWT** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 P** — **Session** (세션·JWT 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 P** — **JWT Access** (세션·JWT 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 P** — **JWT Refresh** (세션·JWT 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 P** — **JWKS** (세션·JWT 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 P** — **검증** (세션·JWT 설정표) NSIGHT 1차 표준 적용 기준입니다.
