...
본 부록은 **검증결과서** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 Z** — **시험 항목** (설정값 검증결과서) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Z** — **실측 기록** (설정값 검증결과서) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Z** — **판정** (설정값 검증결과서) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Z** — **운영 전환** (설정값 검증결과서) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Z** — **이력** (설정값 검증결과서) NSIGHT 1차 표준 적용 기준입니다.
