...
> **용도**: Timeout 계층 · **연관 본문**: 16장

## Timeout 매트릭스 — 실무 템플릿

본 부록은 **Timeout 매트릭스** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 M** — **DB·Pool** (Timeout 매트릭스) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 M** — **Transaction** (Timeout 매트릭스) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 M** — **Proxy·Web** (Timeout 매트릭스) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 M** — **L4** (Timeout 매트릭스) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 M** — **rule-check** (Timeout 매트릭스) NSIGHT 1차 표준 적용 기준입니다.

ENV `/api/oc/env/rule-check`: Timeout 순서·Pool 합산·Thread/Pool 비율.
