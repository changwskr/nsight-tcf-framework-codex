...
> **용도**: Go-Live · **연관 본문**: 52장

## 운영 전환 체크리스트 — 실무 템플릿

본 부록은 **운영 전환** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 AA** — **산정·설정** (운영 전환 체크리스트) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AA** — **시험·rule-check** (운영 전환 체크리스트) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AA** — **Runbook** (운영 전환 체크리스트) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AA** — **배포·Rollback** (운영 전환 체크리스트) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 AA** — **Go-Live** (운영 전환 체크리스트) NSIGHT 1차 표준 적용 기준입니다.
