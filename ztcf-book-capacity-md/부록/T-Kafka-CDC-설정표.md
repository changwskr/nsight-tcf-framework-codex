...
## Kafka·CDC 설정표 — 실무 템플릿

본 부록은 **CDC·Lag** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 T** — **Consumer** (Kafka·CDC 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 T** — **Lag·DLQ** (Kafka·CDC 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 T** — **Partition** (Kafka·CDC 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 T** — **온라인 분리** (Kafka·CDC 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 T** — **검증** (Kafka·CDC 설정표) NSIGHT 1차 표준 적용 기준입니다.
