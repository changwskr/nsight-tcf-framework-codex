...
본 부록은 **TTL·Eviction** 영역의 표준 템플릿입니다. 상단 **NSIGHT 1차 표준 전제**와 함께 사용합니다.
...
본 절은 **부록 Q** — **Local Cache** (Cache 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Q** — **Redis Cache** (Cache 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Q** — **TTL·Eviction** (Cache 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Q** — **Stampede** (Cache 설정표) NSIGHT 1차 표준 적용 기준입니다.
...
본 절은 **부록 Q** — **검증** (Cache 설정표) NSIGHT 1차 표준 적용 기준입니다.
