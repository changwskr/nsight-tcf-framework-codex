...
rem ============================================================
rem  pdmg-fw library JAR build script
rem
rem  Usage:
rem    build.bat                                 clean build (default)
rem    build.bat jar                             run the given Gradle tasks
rem    build.bat clean build --refresh-dependencies
rem    build.bat test                            unit tests only
rem
rem  bootJar is disabled (java-library). Artifact is build\libs\*.jar
rem  consumed by pdmg-service.
rem
