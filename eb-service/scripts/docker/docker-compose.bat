...
rem eb-service docker compose wrapper
...
if errorlevel 1 (
    echo [eb-docker-compose] docker not found. Install Docker Desktop and retry.
    exit /b 1
)

if not exist "!COMPOSE_FILE!" (
    echo [eb-docker-compose] compose file not found: !COMPOSE_FILE!
    exit /b 1
)

if "%~1"=="" goto :usage

echo [eb-docker-compose] docker compose -f docker-compose.yml %*
...
echo   set IMAGE_TAG=nsight-eb:local
exit /b 0
