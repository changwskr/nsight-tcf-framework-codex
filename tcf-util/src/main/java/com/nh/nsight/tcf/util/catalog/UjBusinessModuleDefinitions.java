...
/**
 * tcf-uj {@code BusinessModuleDefinitions} 복사본.
 */
@CopiedFrom(module = "tcf-uj", sourceClass = "BusinessModuleDefinitions", category = UtilCategory.CATALOG)
public final class UjBusinessModuleDefinitions implements CopiedUtilityFlag {

    public static final String COPIED_FROM_MODULE = "tcf-uj";
    public static final String COPIED_FROM_CLASS = "BusinessModuleDefinitions";
    ...
    private UjBusinessModuleDefinitions() {
    }
