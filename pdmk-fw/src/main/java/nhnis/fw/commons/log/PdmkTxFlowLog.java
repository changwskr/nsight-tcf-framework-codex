 ...
 * 시작/종료 로그.
 *
 * <p>Log4j {@code %C.%M} 이 헬퍼({@code PdmkTxFlowLog})가 아니라
 ...
 * </pre>
 */
public final class PdmkTxFlowLog {

    /** LocationAwareLogger 가 이 클래스 프레임을 건너뛰게 하는 FQCN. */
    private static final String FQCN = PdmkTxFlowLog.class.getName();

    private PdmkTxFlowLog() {
    }
