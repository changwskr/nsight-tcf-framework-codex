...
public class ifina8100U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina8100U0DTOout c=new ifina8100U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina8100U0DTOout in=(ifina8100U0DTOout)src;
