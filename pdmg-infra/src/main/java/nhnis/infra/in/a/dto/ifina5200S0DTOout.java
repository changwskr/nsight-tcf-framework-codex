...
public class ifina5200S0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina5200S0DTOout c=new ifina5200S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5200S0DTOout in=(ifina5200S0DTOout)src;
