...
public class ifina2300S0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina2300S0DTOout c=new ifina2300S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina2300S0DTOout in=(ifina2300S0DTOout)src;
