...
public class ifina1500C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina1500C0DTOout c=new ifina1500C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1500C0DTOout in=(ifina1500C0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
