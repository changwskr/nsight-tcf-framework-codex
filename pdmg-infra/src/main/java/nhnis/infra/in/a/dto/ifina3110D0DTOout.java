...
public class ifina3110D0DTOout extends DataObject {
    ...
    @Override public Object clone() { ifina3110D0DTOout c = new ifina3110D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src) {
        if (this == src) return;
        ifina3110D0DTOout in = (ifina3110D0DTOout) src;
