...
public class ifina1400S0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String keyword, gateId, activeYn;
    ...
    @Override public Object clone(){ ifina1400S0DTOin c=new ifina1400S0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1400S0DTOin in=(ifina1400S0DTOin)src;
      keyword=in.keyword; gateId=in.gateId; activeYn=in.activeYn; pageNo=in.pageNo; pageSize=in.pageSize; }
