...
public class ifina7100D0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina7100D0DTOout c=new ifina7100D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7100D0DTOout in=(ifina7100D0DTOout)src;
