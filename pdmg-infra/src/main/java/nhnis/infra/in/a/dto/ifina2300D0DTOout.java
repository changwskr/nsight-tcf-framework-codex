...
public class ifina2300D0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina2300D0DTOout c=new ifina2300D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina2300D0DTOout in=(ifina2300D0DTOout)src;
