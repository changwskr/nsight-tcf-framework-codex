...
public class ifina2100C0DTOout extends DataObject {
    ...
    @Override public Object clone() { ifina2100C0DTOout c = new ifina2100C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src) {
        if (this == src) return;
        ifina2100C0DTOout in = (ifina2100C0DTOout) src;
