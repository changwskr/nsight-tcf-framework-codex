...
public class ifina6100U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina6100U0DTOout c=new ifina6100U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina6100U0DTOout in=(ifina6100U0DTOout)src;
