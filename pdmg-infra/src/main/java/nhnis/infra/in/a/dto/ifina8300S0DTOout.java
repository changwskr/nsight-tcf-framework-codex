...
public class ifina8300S0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina8300S0DTOout c=new ifina8300S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina8300S0DTOout in=(ifina8300S0DTOout)src;
