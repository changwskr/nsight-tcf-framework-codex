...
public class ifina8100D0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina8100D0DTOout c=new ifina8100D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina8100D0DTOout in=(ifina8100D0DTOout)src;
