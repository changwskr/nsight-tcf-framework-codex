...
public class ifina5200D0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina5200D0DTOout c=new ifina5200D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5200D0DTOout in=(ifina5200D0DTOout)src;
