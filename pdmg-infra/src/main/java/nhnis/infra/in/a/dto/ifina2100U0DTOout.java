...
public class ifina2100U0DTOout extends DataObject {
    ...
    @Override public Object clone() { ifina2100U0DTOout c = new ifina2100U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src) {
        if (this == src) return;
        ifina2100U0DTOout in = (ifina2100U0DTOout) src;
