...
public class ifina1400C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina1400C0DTOout c=new ifina1400C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1400C0DTOout in=(ifina1400C0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
