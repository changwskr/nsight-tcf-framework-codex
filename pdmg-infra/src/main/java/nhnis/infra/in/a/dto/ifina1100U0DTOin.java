...
public class ifina1100U0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String codeSetId, codeValue, nameKo, activeYn, remark, chgUserId;
    ...
    @Override public Object clone(){ ifina1100U0DTOin c=new ifina1100U0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1100U0DTOin in=(ifina1100U0DTOin)src; codeSetId=in.codeSetId; codeValue=in.codeValue; nameKo=in.nameKo; activeYn=in.activeYn; remark=in.remark; chgUserId=in.chgUserId; sortOrder=in.sortOrder; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"codeSetId", "codeValue", "nameKo", "activeYn", "remark", "chgUserId"})
