...
public class ifina3100S0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String keyword, assetId, assetName, systemId, groupId, assetKindCd, techRoleCd, envCd, statusCd;
    ...
    @Override public Object clone(){ ifina3100S0DTOin c=new ifina3100S0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina3100S0DTOin in=(ifina3100S0DTOin)src; keyword=in.keyword; assetId=in.assetId; assetName=in.assetName; systemId=in.systemId; groupId=in.groupId; assetKindCd=in.assetKindCd; techRoleCd=in.techRoleCd; envCd=in.envCd; statusCd=in.statusCd; pageNo=in.pageNo; pageSize=in.pageSize; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"keyword", "assetId", "assetName", "systemId", "groupId", "assetKindCd", "techRoleCd", "envCd", "statusCd"})
