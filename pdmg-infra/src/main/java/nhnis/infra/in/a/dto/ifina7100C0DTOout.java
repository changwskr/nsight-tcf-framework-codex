...
public class ifina7100C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina7100C0DTOout c=new ifina7100C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7100C0DTOout in=(ifina7100C0DTOout)src;
