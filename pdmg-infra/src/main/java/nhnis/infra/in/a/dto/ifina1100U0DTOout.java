...
public class ifina1100U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina1100U0DTOout c=new ifina1100U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1100U0DTOout in=(ifina1100U0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
