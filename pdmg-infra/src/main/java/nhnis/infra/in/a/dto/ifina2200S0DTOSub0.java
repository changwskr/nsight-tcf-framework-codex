...
public class ifina2200S0DTOSub0 extends DataObject {
    ...
    private String appId, appName, systemId, langCd, statusCd, remark, regUserId, regDtm, chgUserId, chgDtm;
    ...
    public void clone(DataObject src){ if(this==src)return; ifina2200S0DTOSub0 in=(ifina2200S0DTOSub0)src;
      appId=in.appId; appName=in.appName; systemId=in.systemId; langCd=in.langCd; statusCd=in.statusCd; remark=in.remark;
      regUserId=in.regUserId; regDtm=in.regDtm; chgUserId=in.chgUserId; chgDtm=in.chgDtm; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"appId","appName","systemId","langCd","statusCd","remark","regUserId","regDtm","chgUserId","chgDtm"})
