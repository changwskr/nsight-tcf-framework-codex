...
public class ifina5200C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina5200C0DTOout c=new ifina5200C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5200C0DTOout in=(ifina5200C0DTOout)src;
