...
public class ifina2100C0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String systemId, systemName, ownerOrg, statusCd, remark, regUserId;
    ...
    @Override public Object clone(){ ifina2100C0DTOin c=new ifina2100C0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina2100C0DTOin in=(ifina2100C0DTOin)src;
      systemId=in.systemId; systemName=in.systemName; ownerOrg=in.ownerOrg; statusCd=in.statusCd; remark=in.remark; regUserId=in.regUserId; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"systemId","systemName","ownerOrg","statusCd","remark","regUserId"})
