...
public class ifina8200U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina8200U0DTOout c=new ifina8200U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina8200U0DTOout in=(ifina8200U0DTOout)src;
