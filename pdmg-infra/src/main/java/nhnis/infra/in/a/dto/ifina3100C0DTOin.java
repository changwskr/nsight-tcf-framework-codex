...
public class ifina3100C0DTOin extends DataObject {
    ...
    private String assetId, assetName, groupId, systemId, assetKindCd, techRoleCd, envCd, tierCd, serviceModelCd, deployModelCd, statusCd,
            osName, osVersion, osEolDate, remark, regUserId;
    ...
    @Override public Object clone(){ ifina3100C0DTOin c=new ifina3100C0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina3100C0DTOin in=(ifina3100C0DTOin)src;
      ...
      statusCd=in.statusCd; osName=in.osName; osVersion=in.osVersion; osEolDate=in.osEolDate; remark=in.remark; regUserId=in.regUserId;
      attrs=in.attrs==null?new ArrayList<>():new ArrayList<>(in.attrs); }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"assetId", "assetName", "groupId", "systemId", "assetKindCd", "techRoleCd", "envCd", "tierCd", "serviceModelCd", "deployModelCd", "statusCd", "osName", "osVersion", "osEolDate", "remark", "regUserId"})
