...
public class ifina6200S0DTOin extends DataObject {
    ...
    @Override public Object clone(){ ifina6200S0DTOin c=new ifina6200S0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina6200S0DTOin in=(ifina6200S0DTOin)src;
