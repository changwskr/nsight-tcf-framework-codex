...
public class ifina6300S0DTOin extends DataObject {
    ...
    @Override public Object clone(){ ifina6300S0DTOin c=new ifina6300S0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina6300S0DTOin in=(ifina6300S0DTOin)src;
