...
public class ifina7100U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina7100U0DTOout c=new ifina7100U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7100U0DTOout in=(ifina7100U0DTOout)src;
