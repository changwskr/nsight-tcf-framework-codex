...
public class ifina5100D0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina5100D0DTOout c=new ifina5100D0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5100D0DTOout in=(ifina5100D0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
