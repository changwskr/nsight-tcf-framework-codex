...
public class ifina6200S0DTOout extends DataObject {
    private static final long serialVersionUID = 1L;
    private String targetTypeCd, targetId, RSLT_CD, RSLT_MSG;
    ...
    @Override public Object clone(){ ifina6200S0DTOout c=new ifina6200S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina6200S0DTOout in=(ifina6200S0DTOout)src;
      targetTypeCd=in.targetTypeCd; targetId=in.targetId;
      rows=in.rows==null?new ArrayList<>():new ArrayList<>(in.rows);
      warnings=new ArrayList<>(in.warnings); RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
