...
public class ifina4200U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina4200U0DTOout c=new ifina4200U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina4200U0DTOout in=(ifina4200U0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
