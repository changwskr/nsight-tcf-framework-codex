...
public class ifina3110C0DTOout extends DataObject {
    ...
    @Override public Object clone() { ifina3110C0DTOout c = new ifina3110C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src) {
        if (this == src) return;
        ifina3110C0DTOout in = (ifina3110C0DTOout) src;
