...
public class ifina1200S0DTOSub0 extends DataObject {
    private static final long serialVersionUID = 1L;
    private String entityType, templateId, templateName, techRoleCd, itemId, itemName, itemTypeCd, requiredYn, activeYn, remark, regUserId, regDtm, chgUserId, chgDtm;
    ...
    @Override public Object clone(){ ifina1200S0DTOSub0 c=new ifina1200S0DTOSub0(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1200S0DTOSub0 in=(ifina1200S0DTOSub0)src; entityType=in.entityType; templateId=in.templateId; templateName=in.templateName; techRoleCd=in.techRoleCd; itemId=in.itemId; itemName=in.itemName; itemTypeCd=in.itemTypeCd; requiredYn=in.requiredYn; activeYn=in.activeYn; remark=in.remark; regUserId=in.regUserId; regDtm=in.regDtm; chgUserId=in.chgUserId; chgDtm=in.chgDtm; sortNo=in.sortNo; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"entityType", "templateId", "templateName", "techRoleCd", "itemId", "itemName", "itemTypeCd", "requiredYn", "activeYn", "remark", "regUserId", "regDtm", "chgUserId", "chgDtm"})
