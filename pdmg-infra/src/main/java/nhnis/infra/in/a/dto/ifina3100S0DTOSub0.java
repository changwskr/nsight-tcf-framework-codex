...
public class ifina3100S0DTOSub0 extends DataObject {
    ...
    private String assetId, assetName, groupId, systemId, assetKindCd, techRoleCd, envCd, tierCd, serviceModelCd, deployModelCd, statusCd,
            osName, osVersion, osEolDate, remark, regUserId, regDtm, chgUserId, chgDtm;
    ...
    @Override public Object clone(){ ifina3100S0DTOSub0 c=new ifina3100S0DTOSub0(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina3100S0DTOSub0 in=(ifina3100S0DTOSub0)src;
      ...
      statusCd=in.statusCd; osName=in.osName; osVersion=in.osVersion; osEolDate=in.osEolDate; remark=in.remark;
      regUserId=in.regUserId; regDtm=in.regDtm; chgUserId=in.chgUserId; chgDtm=in.chgDtm; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"assetId", "assetName", "groupId", "systemId", "assetKindCd", "techRoleCd", "envCd", "tierCd", "serviceModelCd", "deployModelCd", "statusCd", "osName", "osVersion", "osEolDate", "remark", "regUserId", "regDtm", "chgUserId", "chgDtm"})
