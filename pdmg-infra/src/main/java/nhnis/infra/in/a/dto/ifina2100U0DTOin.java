...
public class ifina2100U0DTOin extends DataObject {
    ...
    private String systemId, systemName, ownerOrg, statusCd, remark, chgUserId;
    ...
    public void clone(DataObject src){ if(this==src)return; ifina2100U0DTOin in=(ifina2100U0DTOin)src;
      systemId=in.systemId; systemName=in.systemName; ownerOrg=in.ownerOrg; statusCd=in.statusCd; remark=in.remark; chgUserId=in.chgUserId; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"systemId","systemName","ownerOrg","statusCd","remark","chgUserId"})
