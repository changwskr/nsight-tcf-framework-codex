...
public class ifina7100S0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina7100S0DTOout c=new ifina7100S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7100S0DTOout in=(ifina7100S0DTOout)src;
      ...
      warnings=new ArrayList<>(in.warnings); size=in.size; pageNo=in.pageNo; pageSize=in.pageSize;
      totalCount=in.totalCount; totalPages=in.totalPages; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
