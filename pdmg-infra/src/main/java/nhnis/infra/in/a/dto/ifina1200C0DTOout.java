...
public class ifina1200C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina1200C0DTOout c=new ifina1200C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1200C0DTOout in=(ifina1200C0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
