...
public class ifina9200U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina9200U0DTOout c=new ifina9200U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina9200U0DTOout in=(ifina9200U0DTOout)src;
