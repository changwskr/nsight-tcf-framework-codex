...
public class ifina3110C0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String groupId, groupName, systemId, techRoleCd, envCd, tierCd, statusCd, remark, regUserId;
    ...
    @Override public Object clone(){ ifina3110C0DTOin c=new ifina3110C0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina3110C0DTOin in=(ifina3110C0DTOin)src;
      ...
      activeNodes=in.activeNodes; standbyNodes=in.standbyNodes; drNodes=in.drNodes; remark=in.remark; regUserId=in.regUserId; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"groupId","groupName","systemId","techRoleCd","envCd","tierCd","statusCd","remark","regUserId"})
