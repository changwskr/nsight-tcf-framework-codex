...
public class ifina3110U0DTOout extends DataObject {
    ...
    @Override public Object clone() { ifina3110U0DTOout c = new ifina3110U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src) {
        if (this == src) return;
        ifina3110U0DTOout in = (ifina3110U0DTOout) src;
