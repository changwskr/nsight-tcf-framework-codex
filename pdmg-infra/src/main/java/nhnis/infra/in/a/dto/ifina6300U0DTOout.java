...
public class ifina6300U0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina6300U0DTOout c=new ifina6300U0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina6300U0DTOout in=(ifina6300U0DTOout)src;
