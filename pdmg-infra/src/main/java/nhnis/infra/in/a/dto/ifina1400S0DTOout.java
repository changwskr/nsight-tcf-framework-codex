...
public class ifina1400S0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina1400S0DTOout c=new ifina1400S0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1400S0DTOout in=(ifina1400S0DTOout)src;
