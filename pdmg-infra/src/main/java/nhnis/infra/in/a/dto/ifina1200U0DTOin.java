...
public class ifina1200U0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String entityType, templateId, templateName, techRoleCd, itemId, itemName, itemTypeCd, requiredYn, activeYn, remark, chgUserId;
    ...
    @Override public Object clone(){ ifina1200U0DTOin c=new ifina1200U0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina1200U0DTOin in=(ifina1200U0DTOin)src; entityType=in.entityType; templateId=in.templateId; templateName=in.templateName; techRoleCd=in.techRoleCd; itemId=in.itemId; itemName=in.itemName; itemTypeCd=in.itemTypeCd; requiredYn=in.requiredYn; activeYn=in.activeYn; remark=in.remark; chgUserId=in.chgUserId; sortNo=in.sortNo; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"entityType", "templateId", "templateName", "techRoleCd", "itemId", "itemName", "itemTypeCd", "requiredYn", "activeYn", "remark", "chgUserId"})
