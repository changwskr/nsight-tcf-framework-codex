...
public class ifina7200S0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String licenseId;
    public String getLicenseId(){return licenseId;} public void setLicenseId(String v){licenseId=v;}
    @Override public Object clone(){ ifina7200S0DTOin c=new ifina7200S0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7200S0DTOin in=(ifina7200S0DTOin)src; licenseId=in.licenseId; }
