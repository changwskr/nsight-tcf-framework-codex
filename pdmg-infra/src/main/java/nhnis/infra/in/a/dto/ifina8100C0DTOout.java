...
public class ifina8100C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina8100C0DTOout c=new ifina8100C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina8100C0DTOout in=(ifina8100C0DTOout)src;
