...
public class ifina5100C0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String endpointId, assetId, endpointTypeCd, address, portNo, protocolCd, primaryYn, remark, regUserId;
    ...
    @Override public Object clone(){ ifina5100C0DTOin c=new ifina5100C0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5100C0DTOin in=(ifina5100C0DTOin)src;
      endpointId=in.endpointId; assetId=in.assetId; endpointTypeCd=in.endpointTypeCd; address=in.address; portNo=in.portNo; protocolCd=in.protocolCd; primaryYn=in.primaryYn; remark=in.remark; regUserId=in.regUserId; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"endpointId","assetId","endpointTypeCd","address","portNo","protocolCd","primaryYn","remark","regUserId"})
