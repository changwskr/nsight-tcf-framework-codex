...
public class ifina5300C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina5300C0DTOout c=new ifina5300C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina5300C0DTOout in=(ifina5300C0DTOout)src; PROC_CNT=in.PROC_CNT; RSLT_CD=in.RSLT_CD; RSLT_MSG=in.RSLT_MSG; }
