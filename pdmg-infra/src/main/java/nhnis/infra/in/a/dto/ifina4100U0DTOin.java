...
public class ifina4100U0DTOin extends DataObject {
    private static final long serialVersionUID = 1L;
    private String mwId, assetId, productName, versionNo, eolDate, statusCd, remark, chgUserId;
    ...
    @Override public Object clone(){ ifina4100U0DTOin c=new ifina4100U0DTOin(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina4100U0DTOin in=(ifina4100U0DTOin)src;
      mwId=in.mwId; assetId=in.assetId; productName=in.productName; versionNo=in.versionNo; eolDate=in.eolDate; statusCd=in.statusCd; remark=in.remark; chgUserId=in.chgUserId; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"mwId","assetId","productName","versionNo","eolDate","statusCd","remark","chgUserId"})
