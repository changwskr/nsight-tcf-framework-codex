...
public class ifina3110S0DTOSub0 extends DataObject {
    private static final long serialVersionUID = 1L;
    private String groupId, groupName, systemId, techRoleCd, envCd, tierCd, statusCd, remark, regUserId, regDtm, chgUserId, chgDtm;
    ...
    @Override public Object clone(){ ifina3110S0DTOSub0 c=new ifina3110S0DTOSub0(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina3110S0DTOSub0 in=(ifina3110S0DTOSub0)src;
      ...
      activeNodes=in.activeNodes; standbyNodes=in.standbyNodes; drNodes=in.drNodes; remark=in.remark;
      regUserId=in.regUserId; regDtm=in.regDtm; chgUserId=in.chgUserId; chgDtm=in.chgDtm; }
    private static final Map<String, FieldProperty> fieldPropertyMap = new LinkedHashMap<>();
    static { for(String n: new String[]{"groupId","groupName","systemId","techRoleCd","envCd","tierCd","statusCd","remark","regUserId","regDtm","chgUserId","chgDtm"})
