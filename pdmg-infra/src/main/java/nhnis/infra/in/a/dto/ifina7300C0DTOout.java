...
public class ifina7300C0DTOout extends DataObject {
    ...
    @Override public Object clone(){ ifina7300C0DTOout c=new ifina7300C0DTOout(); c.clone(this); return c; }
    public void clone(DataObject src){ if(this==src)return; ifina7300C0DTOout in=(ifina7300C0DTOout)src;
