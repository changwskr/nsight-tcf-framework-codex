...
/**
 * 거래 파라미터 등록 결과 (mgcoa9000C0).
 */
public class mgcoa9000C0DTOout extends DataObject {
    ...
    @Override
    public Object clone() {
        mgcoa9000C0DTOout copy = new mgcoa9000C0DTOout();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mgcoa9000C0DTOout in = (mgcoa9000C0DTOout) src;
