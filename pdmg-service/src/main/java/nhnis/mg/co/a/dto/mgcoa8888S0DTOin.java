...
public class mgcoa8888S0DTOin extends DataObject {
    ...
    /** 트랜잭션 소요시간(응답-요청) 최소 초. null/0이면 미적용 */
    private Integer minElapsedSeconds;
    ...
    public Integer getMinElapsedSeconds() {
        return minElapsedSeconds;
    }

    public void setMinElapsedSeconds(Integer minElapsedSeconds) {
    ...
    public void clone(DataObject src) {
        ...
        this.minElapsedSeconds = in.minElapsedSeconds;
    ...
    static {
        ...
        fieldPropertyMap.put("withinSeconds", FieldProperty.builder()
                ...
                .setType(FieldProperty.TYPE_OBJECT_INT).setDecimal(-1)
                .setIsNullable(true).setIsEncrypt(false).build());
        fieldPropertyMap.put("minElapsedSeconds", FieldProperty.builder()
                .setPhysicalName("minElapsedSeconds").setLogicalName("minElapsedSeconds")
                .setType(FieldProperty.TYPE_OBJECT_INT).setDecimal(-1)
                .setIsNullable(true).setIsEncrypt(false).build());
