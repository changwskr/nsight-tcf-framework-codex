...
/**
 * 거래 파라미터 삭제 결과 (mgcoa9000D0).
 */
public class mgcoa9000D0DTOout extends DataObject {
    ...
    @Override
    public Object clone() {
        mgcoa9000D0DTOout copy = new mgcoa9000D0DTOout();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mgcoa9000D0DTOout in = (mgcoa9000D0DTOout) src;
