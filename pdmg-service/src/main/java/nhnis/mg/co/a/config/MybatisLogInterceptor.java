...
/**
 * SQL 실행 구간을 SQL 로그로 남긴다.
 *
 * <p>log4j2.xml의 {@code nhnis.mg.co.a.config.MybatisLogInterceptor} 로거와 SQL 어펜더가 짝을 이룬다.
 * SQL_HEADER 패턴이 참조하는 {@code %X{sqlId}} MDC 키도 여기에서 채운다.
 */
@Component
@Intercepts({
