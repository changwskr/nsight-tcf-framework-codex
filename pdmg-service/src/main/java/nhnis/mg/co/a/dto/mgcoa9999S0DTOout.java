...
public class mgcoa9999S0DTOout extends DataObject
{
    ...
    private List<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0> mgcoa9999S0DTOSub0 = null;

    public List<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0> getmgcoa9999S0DTOSub0List() {
    ...
    public void ensureCapacitymgcoa9999S0DTOSub0(int minCapacity) {
        if(mgcoa9999S0DTOSub0 == null)
            mgcoa9999S0DTOSub0 =
                    new ArrayList<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0>(minCapacity);
        else
            ((ArrayList<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0>)mgcoa9999S0DTOSub0)
    ...
    public List<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0> getmgcoa9999S0DTOSub0() {
    ...
    public nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0[] getmgcoa9999S0DTOSub0Array() {
        if(this.mgcoa9999S0DTOSub0 == null)
            return null;

        return this.mgcoa9999S0DTOSub0.toArray(
                new nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0[mgcoa9999S0DTOSub0.size()]);
    }

    public nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0 getmgcoa9999S0DTOSub0(int _index) {
        return (nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0)
                mgcoa9999S0DTOSub0.get(_index);
    }

    public void setmgcoa9999S0DTOSub0(
            List<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0> mgcoa9999S0DTOSub0) {
    ...
    public void setmgcoa9999S0DTOSub0Array(
            nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0[] mgcoa9999S0DTOSub0Array) {
    ...
    public void addmgcoa9999S0DTOSub0(
            int _index,
            nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0 mgcoa9999S0DTOSub0) {
        if(this.mgcoa9999S0DTOSub0 == null)
            this.mgcoa9999S0DTOSub0 =
                    new ArrayList<nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0>((int)size);
        if(mgcoa9999S0DTOSub0 == null) {
    ...
    static {
        ...
        fieldPropertyMap.put("mgcoa9999S0DTOSub0", FieldProperty.builder()
                ...
                .setDecimal(-1)
                .setArray("size")
                .setReference("nhnis.mg.co.a.dto.mgcoa9999S0DTOSub0")
                .setIsNullable(true)
                .setIsEncrypt(false)
                .build());
