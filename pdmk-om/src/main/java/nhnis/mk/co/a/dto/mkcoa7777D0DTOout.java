...
/**
 * 이미지로그 삭제 결과 (mkcoa7777D0).
 */
public class mkcoa7777D0DTOout extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa7777D0DTOout copy = new mkcoa7777D0DTOout();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa7777D0DTOout in = (mkcoa7777D0DTOout) src;
