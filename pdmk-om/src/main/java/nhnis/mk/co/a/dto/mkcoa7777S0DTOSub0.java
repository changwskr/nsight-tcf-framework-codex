...
/**
 * 이미지로그 목록 Sub DTO (mkcoa7777S0).
 */
public class mkcoa7777S0DTOSub0 extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa7777S0DTOSub0 copy = new mkcoa7777S0DTOSub0();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa7777S0DTOSub0 in = (mkcoa7777S0DTOSub0) src;
        this.guid = in.guid;
