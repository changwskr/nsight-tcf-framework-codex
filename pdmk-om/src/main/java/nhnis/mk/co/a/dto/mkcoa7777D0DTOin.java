...
/**
 * 이미지로그 삭제 입력 (mkcoa7777D0).
 */
public class mkcoa7777D0DTOin extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa7777D0DTOin copy = new mkcoa7777D0DTOin();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa7777D0DTOin in = (mkcoa7777D0DTOin) src;
