...
public class BizPrePostAspect {
    ...
    public void before(JoinPoint joinPoint) {
        PdmkTxFlowLog.enter(log, BizPrePostAspect.class, "before");
        try {
            ...
            PdmkTxFlowLog.leave(log, BizPrePostAspect.class, "before");
        }
    }

    @AfterReturning(pointcut = "mkCoControllers()", returning = "result")
    public void after(JoinPoint joinPoint, Object result) {
        PdmkTxFlowLog.enter(log, BizPrePostAspect.class, "after");
        try {
            ...
            PdmkTxFlowLog.leave(log, BizPrePostAspect.class, "after");
        }
    }
