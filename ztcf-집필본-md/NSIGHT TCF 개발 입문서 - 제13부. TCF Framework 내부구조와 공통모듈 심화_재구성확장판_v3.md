<!-- source: ztcf-집필본/NSIGHT TCF 개발 입문서 - 제13부. TCF Framework 내부구조와 공통모듈 심화_재구성확장판_v3.docx -->
<!-- tables: mammoth-html + placeholder table-to-md -->

나는 제13부. TCF Framework 내부구조와 공통모듈 심화의 개념을 코드·설정·로그·산출물 중 어디에서 확인할 수 있는가? 문제가 발생했을 때 어느 경계부터 조사해야 하는가?
...
1.  TCF 공통모듈의 전체 구성을 설명한다.
2.  tcf-core의 거래 처리 흐름을 이해한다.
3.  STF와 ETF의 책임을 구분한다.
4.  Dispatcher와 Handler Registry의 역할을 설명한다.
5.  tcf-web의 Controller와 Filter 역할을 이해한다.
6.  tcf-jwt의 발급·검증·키 관리 구조를 이해한다.
7.  tcf-gateway의 인증·라우팅·Header 재작성 책임을 이해한다.
8.  tcf-cache를 이용해 Cache 구현기술과 업무코드를 분리한다.
9.  tcf-eai의 Adapter와 외부 오류 변환 구조를 이해한다.
10.  tcf-batch의 Job 실행과 운영 Metadata를 이해한다.
11.  tcf-om의 기준정보·관측·통제 책임을 이해한다.
12.  공통모듈 간 허용 의존성과 금지 의존성을 구분한다.
13.  Framework 확장점과 업무 확장점을 구분한다.
14.  공통모듈 변경 시 호환성·배포 영향을 분석한다.
15.  Architecture Gate로 모듈 경계를 자동검증한다.
...
학습 목표 | 114장. TCF 공통모듈 전체 지도의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 114장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 115장. tcf-util 기반모듈의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 115장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 116장. tcf-core 거래 처리 엔진의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 116장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 117장. STF·Dispatcher·ETF 내부구조의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 117장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 118장. tcf-web HTTP 진입계층의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 118장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 119장. tcf-jwt 토큰 공통모듈의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 119장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 120장. tcf-gateway 진입·인증·라우팅의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 120장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 121장. tcf-cache와 tcf-eai의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 121장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 122장. tcf-batch와 tcf-om의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 122장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 123장. 모듈 의존성·확장·호환성 관리의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 123장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
