<!-- source: ztcf-집필본/NSIGHT TCF 개발 입문서 - 제17부. 개발환경 구축 Git Gradle 로컬 실행 디버깅 실전_재구성확장판_v3.docx -->
<!-- tables: mammoth-html + placeholder table-to-md -->

나는 제17부. 개발환경 구축·Git·Gradle·로컬 실행·디버깅 실전의 개념을 코드·설정·로그·산출물 중 어디에서 확인할 수 있는가? 문제가 발생했을 때 어느 경계부터 조사해야 하는가?
...
1.  개발 PC에 필요한 도구를 설치한다.
2.  JDK와 환경변수를 올바르게 설정한다.
3.  Git 저장소를 Clone하고 Branch를 생성한다.
4.  Gradle Wrapper로 멀티모듈 프로젝트를 Build한다.
5.  Eclipse 또는 IntelliJ에 Gradle 프로젝트를 등록한다.
6.  공통모듈과 업무 WAR의 관계를 이해한다.
7.  로컬 Profile과 Secret을 분리한다.
8.  로컬 DB와 Mapper를 설정한다.
9.  Spring Boot 방식으로 업무모듈을 실행한다.
10.  WAR를 외부 Tomcat에 배포한다.
11.  표준 요청 전문으로 첫 ServiceId를 호출한다.
12.  Controller부터 Mapper까지 중단점을 설정한다.
13.  인증·권한·ServiceId·Mapper 오류를 구분한다.
14.  Thread·Transaction·SQL 실행상태를 확인한다.
15.  IDE와 CI Build 결과의 차이를 제거한다.
16.  개발환경 점검표와 품질 Gate를 적용한다.
...
학습 목표 | 161장. 개발환경 전체 구성 이해하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 161장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 162장. JDK·환경변수·인코딩 설정의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 162장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 163장. Git 저장소 Clone과 최초 점검의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 163장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 164장. Git Branch·Commit·협업 실전의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 164장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 165장. Gradle 멀티모듈 Build 이해하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 165장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 166장. Eclipse·IntelliJ 프로젝트 등록의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 166장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 167장. 로컬 Profile·환경설정·Secret 관리의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
IC\_SERVICE\_BASE\_URL

LOCAL\_SERVER\_PORT

PowerShell:

$env:CT\_DB\_URL="jdbc:h2:mem:ctdb"
$env:CT\_DB\_USERNAME="sa"
$env:CT\_DB\_PASSWORD=""
...
datasource:
url: ${CT\_DB\_URL}
username: ${CT\_DB\_USERNAME}
password: ${CT\_DB\_PASSWORD}

server:
port: ${LOCAL\_SERVER\_PORT:8080}
...
clients:
ic:
base-url: ${IC\_SERVICE\_BASE\_URL:http://localhost:8081}
...
학습 목표 | 167장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 168장. 로컬 DB·DataSource·Mapper 준비의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 168장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 169장. Spring Boot 방식으로 로컬 실행의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 169장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 170장. 외부 Tomcat에 WAR 배포하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
set "JAVA\_HOME=C:\\Program Files\\Java\\jdk-17"
set "CATALINA\_OPTS=-Xms2g -Xmx2g"
set "CATALINA\_OPTS=%CATALINA\_OPTS% -Dspring.profiles.active=local"
set "CATALINA\_OPTS=%CATALINA\_OPTS% -Dfile.encoding=UTF-8"

Linux setenv.sh:

export JAVA\_HOME=/opt/jdk-17

export CATALINA\_OPTS="$CATALINA\_OPTS -Xms2g -Xmx2g"
export CATALINA\_OPTS="$CATALINA\_OPTS -Dspring.profiles.active=local"
export CATALINA\_OPTS="$CATALINA\_OPTS -Dfile.encoding=UTF-8"
...
학습 목표 | 170장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 171장. 첫 번째 ServiceId 거래 호출의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 171장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 172장. Controller부터 Mapper까지 디버깅의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 172장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 173장. 로그·Trace·SQL을 함께 이용한 디버깅의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 173장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 174장. 자주 발생하는 Build·기동·실행 오류의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 174장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 175장. IDE와 CI/CD 환경 정합성의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 175장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 176장. 신규 개발자 첫날부터 첫 거래까지의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 176장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
