<!-- source: ztcf-집필본/NSIGHT TCF 개발 입문서 - 제1부 TCF Framework 이해하기_재구성확장판_v3.docx -->
<!-- tables: mammoth-html + placeholder table-to-md -->

나는 제1부. TCF Framework 이해하기의 개념을 코드·설정·로그·산출물 중 어디에서 확인할 수 있는가? 문제가 발생했을 때 어느 경계부터 조사해야 하는가?
...
이 단어들을 하나씩 검색하면 뜻은 알 수 있습니다. 하지만 실제 프로젝트에서 더 어려운 것은 **각 기술이 어떤 순서로 연결되는지 이해하는 것**입니다.
...
1.  TCF가 무엇인가?
2.  사용자의 요청은 어느 시스템을 거쳐 가는가?
3.  요청 한 건은 서버 내부에서 어떤 순서로 처리되는가?
4.  Handler, Facade, Service, Rule, DAO, Mapper는 각각 무엇을 하는가?
...
학습 목표 | 1장. TCF가 뭐예요?의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
중요한 것은 **일반 업무 온라인 거래를 임의의 Controller로 우회하지 않는 것**입니다.
...
학습 목표 | 1장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 2장. 시스템 그림 한 장의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 2장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 3장. 요청이 지나가는 길의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 3장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 4장. 6계층, 역할만 기억하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 4장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
