<!-- source: ztcf-집필본/NSIGHT TCF 개발 입문서 - 제2부 개발표준과 거래 식별 이해하기_재구성확장판_v3.docx -->
<!-- tables: mammoth-html + placeholder table-to-md -->

나는 제2부. 개발표준과 거래 식별 이해하기의 개념을 코드·설정·로그·산출물 중 어디에서 확인할 수 있는가? 문제가 발생했을 때 어느 경계부터 조사해야 하는가?
...
TCF의 존재 이유와 표준 식별 체계를 먼저 익혀 이후 구현 판단의 기준을 세웁니다.
...
제2부에서는 이 처리 흐름에 필요한 **이름과 형식**을 배웁니다.
...
1.  기능이 속한 업무코드를 선택한다.
2.  화면과 이벤트를 식별한다.
3.  ServiceId를 표준 형식으로 작성한다.
4.  거래코드를 ServiceId와 구분하여 작성한다.
5.  표준 요청·응답 JSON을 작성한다.
6.  ServiceId와 Handler를 연결한다.
7.  OM 등록에 필요한 정보를 정리한다.
8.  화면부터 SQL까지 추적관계를 설명한다.
...
학습 목표 | 5장. 개발표준은 왜 필요한가요?의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 5장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 6장. 업무코드와 업무 경계의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 6장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 7장. ServiceId 설계하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 7장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 8장. 거래코드 이해하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 8장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 9장. 표준 요청 전문의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 9장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 10장. 표준 응답 전문의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 10장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
학습 목표 | 11장. 화면 이벤트부터 OM까지 연결하기의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
...
| --- | --- | --- | --- |
| SV.Customer.selectSummary | SvCustomerMapper.selectCustomerSummary | SELECT | SV\_CUSTOMER\_SUMMARY |
| SV.Customer.selectDetail | SvCustomerMapper.selectCustomerDetail | SELECT | SV\_CUSTOMER\_DETAIL |
| SV.Customer.updateContact | SvCustomerMapper.updateCustomerContact | UPDATE | SV\_CUSTOMER\_CONTACT |
...
학습 목표 | 11장 요약의 핵심 개념을 설명하고, 프로젝트에서 적용 위치와 검증 방법을 스스로 판단한다.
