...
/**
 * 이미지로그 삭제 결과 (mkcoa8888D0).
 */
public class mkcoa8888D0DTOout extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa8888D0DTOout copy = new mkcoa8888D0DTOout();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa8888D0DTOout in = (mkcoa8888D0DTOout) src;
