...
/**
 * 이미지로그 삭제 입력 (mkcoa8888D0).
 */
public class mkcoa8888D0DTOin extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa8888D0DTOin copy = new mkcoa8888D0DTOin();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa8888D0DTOin in = (mkcoa8888D0DTOin) src;
