...
/**
 * 마케팅희망고객 목록 Sub DTO (mkcoa5530S0).
 */
public class mkcoa5530S0DTOSub0 extends DataObject {
    ...
    @Override
    public Object clone() {
        mkcoa5530S0DTOSub0 copy = new mkcoa5530S0DTOSub0();
        copy.clone(this);
        return copy;
    }
    ...
    public void clone(DataObject src) {
        ...
        mkcoa5530S0DTOSub0 in = (mkcoa5530S0DTOSub0) src;
        this.l5101 = in.l5101;
        this.l5102 = in.l5102;
        this.l5103 = in.l5103;
        this.l5104 = in.l5104;
