...
rem tcf-ui docker compose wrapper
...
if errorlevel 1 (
    echo [ui-docker-compose] docker not found. Install Docker Desktop and retry.
    exit /b 1
)

if not exist "!COMPOSE_FILE!" (
    echo [ui-docker-compose] compose file not found: !COMPOSE_FILE!
    exit /b 1
)

if "%~1"=="" goto :usage

echo [ui-docker-compose] docker compose -f docker-compose.yml %*
...
echo   set IMAGE_TAG=nsight-ui:local
exit /b 0
