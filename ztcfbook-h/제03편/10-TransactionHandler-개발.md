...
| **기반 원본** | [ztcfbook/제03편/10-TransactionHandler-개발.md](../ztcfbook/제03편/10-TransactionHandler-개발.md) |
...
TransactionHandler는 @Component로 등록되고 serviceIds()로 담당 ServiceId를 선언하며, handle() 내부 switch에서 Facade로 위임합니다. default 분기는 SERVICE_NOT_FOUND BusinessException으로 ETF까지 일관된 오류 응답을 보장해야 합니다.
...
## Master Deep Dive — TransactionHandler 개발
...
| --- | --- |
| ztcfbook-h | 본 파일 |
| ztcfbook | `../ztcfbook/제03편/10-TransactionHandler-개발.md` |
