...
부록 E Mapper XML 템플릿은 namespace=DAO FQCN, ResultMap, dynamic where, count·select 분리 페이징 패턴을 SvCustomerMapper.xml로 고정합니다. MyBatis 바인딩은 ${} 문자열 치환이 아니라 #{} 파라미터 바인딩만 허용하며, 이는 SQL injection 방어와 코드 리뷰의 Blocker 항목입니다.
...
## Master Deep Dive — 부록 E · Mapper XML
...
| --- | --- |
| ztcfbook-h | 본 파일 |
| ztcfbook | `../ztcfbook/부록/E-Mapper-XML-템플릿.md` |
