...
| **기반 원본** | [ztcfbook/제05편/17-Batch-Scheduler-이벤트.md](../ztcfbook/제05편/17-Batch-Scheduler-이벤트.md) |
...
tcf-batch Scheduler(SessionStatusCollectScheduler 등)는 OM Dashboard metrics·헬스 feed를 비동기로 공급합니다. 온라인 TCF 파이프라인(STF~ETF)과 lifecycle·장애 모드가 분리되어 있어, batch down이 online 거래를 막지는 않지만 observability blind spot이 생깁니다.
...
## Master Deep Dive — Batch · Scheduler · 이벤트
...
- [zarchitecture/12-배치-모니터링-아키텍처.md](../zarchitecture/12-배치-모니터링-아키텍처.md)
...
| --- | --- |
| ztcfbook-h | 본 파일 |
| ztcfbook | `../ztcfbook/제05편/17-Batch-Scheduler-이벤트.md` |
